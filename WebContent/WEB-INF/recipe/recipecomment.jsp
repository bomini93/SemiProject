...
<form action="/recipe/comment" method="post" enctype="utf-8">
<div id="div7">
   <label>별점
...
<div id = "div8">
   ...
   <label>내용<br>
      <textarea id="content" name="recipe_review_text" cols=40px; rows=15px; placeholder="내용을 입력 해주세요" ></textarea>
   </label><br><br>
</div>

<div id = "div9">   
   <input type="hidden" name="recipe_rating"/>
   <button>작성</button>
</div>
