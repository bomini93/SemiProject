...
<label>내용<br>
	<textarea id="content" name="rest_review_text" cols=40px; rows=15px; placeholder="수정할 내용을 입력해주세요"></textarea>
</label><br><br>
</div>

<div id="div9">
<input type="hidden"id="star" name="rest_rating">
<input type="hidden"name="review_no" value="<%=review_no%>">
  
<button id="change">수정 완료</button>
</div>
</form>
